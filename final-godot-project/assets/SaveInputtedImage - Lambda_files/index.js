import{importUnifiedConsoleApp as d}from"./loader.js";const i=`<div id="skeleton-nav-awt-wrapper" data-testid="skeleton-nav-awt-wrapper">
...
</div>`,c=async()=>{var e,t;if((t=(e=window.AWSC)==null?void 0:e.NavFAC)==null?void 0:t.isFeatureEnabled("unified_nav_awt")){const o=await w("#consoleNavHeader",1e4);o&&(o.innerHTML=i)}};async function w(a,e){const t=new Promise(l=>setTimeout(()=>l(null),e)),o=new Promise(l=>{const s=document.querySelector(a);if(s){l(s);return}new MutationObserver((v,r)=>{const n=document.querySelector(a);n&&(l(n),r.disconnect())}).observe(document.documentElement,{childList:!0,subtree:!0})});return Promise.race([t,o])}(async()=>{try{c();const{initializeUnifiedConsoleApp:a}=await d();a==null||a()}catch{}})();
